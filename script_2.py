...
# Create country-selector.js with ALL Amazon links
country_selector_js = '''// Country Selector with All Amazon Links
const amazonLinks = {
    uk: {
...
with open('wintering-well-website/js/country-selector.js', 'w', encoding='utf-8') as f:
    f.write(country_selector_js)

print("✅ Created country-selector.js with all 13 Amazon countries")
